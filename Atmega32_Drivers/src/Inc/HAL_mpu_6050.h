...
// Define the slave address for the MPU6050 sensor
#define MPU6050_Slave_Address 0x68

#define I2C_init() (I2C_init(I2C_MASTER, I2C_Prescaler_1, MPU6050_Slave_Address))
// #define I2C_start() (I2C_start())
// #define I2C_stop() (i2c_stop_cond())
#define I2C_send(x) (I2C_write(x))
#define I2C_get(x) (I2C_read_ack(x))
